      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex flex-wrap gap-6 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[0.65rem] text-hawk-border-hover ml-2">
              v1.0
            </span>
          </div>
        ...
        <div className="mt-6 pt-5 border-t border-hawk-border flex items-center gap-2">
          ...
          <span className="font-mono text-[0.68rem] text-center text-hawk-muted">
            All analysis is performed server-side. No email data is stored or
            logged. External API calls are made per-request only.
          </span>
        </div>
      </div>
    </footer>
